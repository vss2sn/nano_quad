...
static void gains_callback(const quadrotor_msgs::Gains::ConstPtr &msg)
{
  quadrotor_msgs::Serial serial_msg;
  serial_msg.header.seq = msg->header.seq;
  serial_msg.channel = channel;
  ...
  quadrotor_msgs::encodeGainsCommand(*msg, serial_msg.data);
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber gains_sub = n.subscribe("gains", 10, &gains_callback,
                                          ros::TransportHints().tcpNoDelay());
